      ...
      {activeTab === 'resumen' && (
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1.6fr) minmax(320px, 1fr)', gap: '1.5rem', alignItems: 'start' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            >
              ...
              {vitalsView === 'summary' && (
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '1rem' }}>
                  ...
                  {/* Heart Rate / Ritmo Cardíaco KPI Tile */}
                  <div
                    style={{
                      padding: '1.1rem 1.25rem',
                      backgroundColor: '#f8fafc',
            ...
            {/* 2. DIAGNÓSTICOS ACTIVOS CARD (Matching the attached design image) */}
            <div
              style={{
                backgroundColor: '#ffffff',
                borderRadius: '0.875rem',
              ...
              {conditions.length > 0 ? (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                  {conditions.slice(0, 4).map((c, idx) => {
                    const name = c.code?.text || c.code?.coding?.[0]?.display || 'Diagnóstico';
          ...
          {/* RIGHT COLUMN: LÍNEA DE TIEMPO (Clinical Timeline matching image) */}
          <div>
            <ClinicalTimeline
                ...
                <tbody>
                  {encounters.map(enc => (
                    <tr key={enc.id}>
                      ...
                      <td>{enc.participant?.[0]?.individual?.display || 'Personal Médico'}</td>
