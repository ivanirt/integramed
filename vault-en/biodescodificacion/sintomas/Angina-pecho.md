---
type: SymptomConflict
title: Angina-pecho
description: "Hipotesis de conflicto para Angina-pecho (paráfrasis de escuela, no cita)."
...
**Capa / territorio (escuela):** urgencia médica primero

**Tema de conflicto (paráfrasis, no texto del libro):** literatura: territorio del corazón / ser querido en peligro — NO sustituye urgencias

**Pregunta de entrevista:** Remitir a urgencias. Luego, si acaso, el tema de amenaza al vínculo.

**Tres tiempos:** [[biodescodificacion/teoria/Tres-tiempos]]

Prioridad clínica: veto. Ver [[biodescodificacion/agent/DISCLAIMER]].
