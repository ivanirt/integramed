...
title: Ansiedad
description: "Hipotesis de conflicto para Ansiedad (paráfrasis de escuela, no cita)."
...
**Capa / territorio (escuela):** sistema de alarma

**Tema de conflicto (paráfrasis, no texto del libro):** miedo no nombrado; futuro sentido como ataque

**Pregunta de entrevista:** ¿A qué pérdida anticipo sin decirlo?
