...
title: Artrosis
description: "Hipotesis de conflicto para Artrosis (paráfrasis de escuela, no cita)."
...
**Capa / territorio (escuela):** desgaste de estructura

**Tema de conflicto (paráfrasis, no texto del libro):** rigidez ante un “tengo que aguantar”; desvalorización del movimiento

**Pregunta de entrevista:** ¿Qué carga llevo años sin soltar?
