...
title: Asma
description: "Hipotesis de conflicto para Asma (paráfrasis de escuela, no cita)."
...
**Capa / territorio (escuela):** territorio aéreo / mamá-nido

**Tema de conflicto (paráfrasis, no texto del libro):** literatura clásica: miedo a perder el nido o a ahogarse en una relación

**Pregunta de entrevista:** ¿Dónde no puedo tomar aire propio?
