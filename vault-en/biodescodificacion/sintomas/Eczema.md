...
title: Eczema
description: "Hipotesis de conflicto para Eczema (paráfrasis de escuela, no cita)."
...
**Capa / territorio (escuela):** ecto / separación

**Tema de conflicto (paráfrasis, no texto del libro):** conflicto de separación o de contacto tóxico en la piel-límite

**Pregunta de entrevista:** ¿De quién no pude separarme o a quién no pude tocar en paz?

**Tres tiempos:** [[biodescodificacion/teoria/Tres-tiempos]]

Prioridad clínica: ok. Ver [[biodescodificacion/agent/DISCLAIMER]].
