...
description: "Hipotesis de conflicto para Esclerosis-multiple (paráfrasis de escuela, no cita)."
...
**Tema de conflicto (paráfrasis, no texto del libro):** la escuela propone conflictos de motor y mielina; evidencia causal nula

**Pregunta de entrevista:** Neurología primero.
