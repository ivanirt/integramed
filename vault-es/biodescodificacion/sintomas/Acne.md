...
title: Acne
description: "Hipotesis de conflicto para Acne (paráfrasis de escuela, no cita)."
...
**Capa / territorio (escuela):** piel / contacto

**Tema de conflicto (paráfrasis, no texto del libro):** vergüenza de mostrarse, juicio sobre la imagen

**Pregunta de entrevista:** ¿Qué parte de mí no quiero que vean?
