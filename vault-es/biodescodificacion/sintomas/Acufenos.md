...
title: Acufenos
description: "Hipotesis de conflicto para Acufenos (paráfrasis de escuela, no cita)."
...
**Capa / territorio (escuela):** oido / alerta

**Tema de conflicto (paráfrasis, no texto del libro):** no querer oír algo, o hiper-alerta a un peligro

**Pregunta de entrevista:** ¿Qué no quiero escuchar?
