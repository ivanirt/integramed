...
title: Cancer
description: "Hipotesis de conflicto para Cancer (paráfrasis de escuela, no cita)."
...
**Capa / territorio (escuela):** veto medico

**Tema de conflicto (paráfrasis, no texto del libro):** la escuela habla de conflicto dramático de larga duración; el agente NO causaliza el tumor

**Pregunta de entrevista:** Oncología primero. La narrativa emocional es adjunta, no etiología.
