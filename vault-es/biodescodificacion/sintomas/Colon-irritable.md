...
description: "Hipotesis de conflicto para Colon-irritable (paráfrasis de escuela, no cita)."
...
**Capa / territorio (escuela):** endodermo / digerir el clan

**Tema de conflicto (paráfrasis, no texto del libro):** indigestión de una historia familiar o de una exigencia

**Pregunta de entrevista:** ¿Qué del clan no digiero?
