...
title: Corazon
description: "Hipotesis de conflicto para Corazon (paráfrasis de escuela, no cita)."
...
**Capa / territorio (escuela):** vínculo

**Tema de conflicto (paráfrasis, no texto del libro):** miedo a perder el ser querido o a no ser querido; incoherencia afectiva

**Pregunta de entrevista:** Tras cribado médico: ¿qué vínculo está en juego?
