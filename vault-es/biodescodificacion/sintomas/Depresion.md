...
title: Depresion
description: "Hipotesis de conflicto para Depresion (paráfrasis de escuela, no cita)."
...
**Capa / territorio (escuela):** bajada de programa

**Tema de conflicto (paráfrasis, no texto del libro):** desvalorización, duelo no hecho, lealtad a un muerto

**Pregunta de entrevista:** Riesgo suicida = crisis, no diccionario.
