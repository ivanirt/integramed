...
type: Meridian
title: Estomago
description: "Canal Estomago según catálogo Padilla (paráfrasis)."
...
# Estomago (E / Zu Yangming)

**Elemento:** Tierra

## Trayecto (resumen)
Infraorbitario → cara → cuello → tórax → abdomen → pierna anterolateral → 2º dedo.

## Clínica habitual en el curso
digestión, cara, hambre, preocupar
