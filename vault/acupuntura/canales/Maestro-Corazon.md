---
type: Meridian
title: Maestro-Corazon
description: "Canal Maestro-Corazon según catálogo Padilla (paráfrasis)."
tags: [alt-med, okf, tcm, canal]
generated:
...
canal: Maestro-Corazon
abrev: MC
eje: Shou Jueyin
elemento: Fuego-ministro
---

# Maestro-Corazon (MC / Shou Jueyin)

**Elemento:** Fuego-ministro

## Trayecto (resumen)
Pecho → cara palmar antebrazo → dedo medio. Xin Bao, barrera del emperador.

## Clínica habitual en el curso
ansiedad, náusea, pecho oprimido

## Relacionados
- Lista: [[acupuntura/indexes/CANALES]]
- Puntos: [[acupuntura/indexes/PUNTOS-CLAVE]]
