...
type: Meridian
title: Sanjiao
description: "Canal Sanjiao según catálogo Padilla (paráfrasis)."
...
# Sanjiao (TR / Shou Shaoyang)

**Elemento:** Fuego-ministro

## Trayecto (resumen)
Anular → dorso antebrazo → hombro → oreja → ceja. Tres fogones.

## Clínica habitual en el curso
oído, edema, regulación de líquidos
