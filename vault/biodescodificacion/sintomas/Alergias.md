...
title: Alergias
description: "Hipotesis de conflicto para Alergias (paráfrasis de escuela, no cita)."
...
**Capa / territorio (escuela):** ecto / frontera

**Tema de conflicto (paráfrasis, no texto del libro):** intolerancia a un “otro” o a un ambiente sentido como invasor

**Pregunta de entrevista:** ¿Qué o quién siento que me invade?
