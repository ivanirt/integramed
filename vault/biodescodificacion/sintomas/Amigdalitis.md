...
title: Amigdalitis
description: "Hipotesis de conflicto para Amigdalitis (paráfrasis de escuela, no cita)."
...
**Capa / territorio (escuela):** filtro de lo que entra

**Tema de conflicto (paráfrasis, no texto del libro):** conflicto de tragar palabras o de defender la puerta de casa

**Pregunta de entrevista:** ¿Qué palabra no salió o no entré?
