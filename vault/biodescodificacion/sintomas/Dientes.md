...
title: Dientes
description: "Hipotesis de conflicto para Dientes (paráfrasis de escuela, no cita)."
...
**Capa / territorio (escuela):** agarrar / decidir

**Tema de conflicto (paráfrasis, no texto del libro):** rabia contenida, no morder la vida o no cortar un lazo

**Pregunta de entrevista:** ¿Qué no me atrevo a morder o a soltar?
