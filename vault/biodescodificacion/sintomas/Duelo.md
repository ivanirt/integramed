...
title: Duelo
description: "Hipotesis de conflicto para Duelo (paráfrasis de escuela, no cita)."
...
**Capa / territorio (escuela):** perdida

**Tema de conflicto (paráfrasis, no texto del libro):** lo no dicho al muerto; palabras que pesan

**Pregunta de entrevista:** ¿Qué frase no se dijo?
